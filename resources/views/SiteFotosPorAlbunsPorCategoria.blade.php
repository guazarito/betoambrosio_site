...
@section('meta_tags')
	<meta property="og:title"  content="Beto Ambrosio | {{$categoria->titulo}} | {{$album->titulo}} " />
	<meta property="og:url"    content="http://www.betoambrosio.com.br/albuns/categoria/{{$categoria->id}}/{{$album->id}}" />
	<meta property="og:type"   content="website" />
	<meta property="og:image"  content="http://betoambrosio.com.br/layout/img/og_tags/al_{{$album->id}}.jpg" />
@endsection
...
@section('album')
	 <div id="s_infos_album">
	       <h1 class="s_album_titulo">{{$album->titulo}}</h1> <!--  titulo album -->
	        ...
	        <h4 class="s_album_categoria text-muted">Categoria: <u>{{$categoria->titulo}}</u> </h4> <!--  categoria album -->
	</div>
@endsection
