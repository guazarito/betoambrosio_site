...
@section('meta_tags')
	<meta property="og:title"  content="Beto Ambrosio | {{$categoria->titulo}} " />
	<meta property="og:url"    content="http://www.betoambrosio.com.br/albuns/categoria/{{$categoria->id}}" />
	<meta property="og:type"   content="website" />
	<meta property="og:image"  content="http://betoambrosio.com.br/layout/img/og_tags/cat_{{$categoria->id}}.jpg" />
@endsection
